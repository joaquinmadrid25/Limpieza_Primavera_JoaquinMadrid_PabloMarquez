...
public class FacturacionLegacyTest {
    ...
    public void testClienteVipConDescuentoExtra() {
        ...
        assertEquals(75.0, facturacion.calculoTotal(100.0, 1, true), 0.001,
    ...
    public void testClienteVipSinDescuentoExtra() {
        ...
        assertEquals(85.0, facturacion.calculoTotal(100.0, 1, false), 0.001,
    ...
    public void testClienteEstandar() {
        ...
        assertEquals(95.0, facturacion.calculoTotal(100.0, 2, false), 0.001,
                "Fallo: El cliente Estándar debe pagar 95.0");
        assertEquals(95.0, facturacion.calculoTotal(100.0, 2, true), 0.001,
    ...
    public void testClienteSinCategoria() {
        ...
        assertEquals(100.0, facturacion.calculoTotal(100.0, 3, false), 0.001,
    ...
    public void testImporteNegativoOCero() {
        // m <= 0 -> 0
        assertEquals(0.0, facturacion.calculoTotal(0.0, 1, true), 0.001,
                "Fallo: Importe 0 debe devolver 0");
        assertEquals(0.0, facturacion.calculoTotal(-50.0, 2, false), 0.001,
